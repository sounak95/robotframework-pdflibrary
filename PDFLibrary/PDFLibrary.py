...
class PDFLibrary(object):
    ...
    def mx_pdf_text_compare(self, filepath, string=None, prefix=None, suffix=None, all_occurrence="False", password=None):
        ...
        |Mx Pdf Text Compare| ${filepath} | ${string} |

        2. To Validate Text In PDF For All Occurrence :
        |Mx Pdf Text Compare| ${filepath} | ${string} | all_occurrence=True |

        3. To Validate Text In PDF For First Occurrence With Prefix And Suffix :
        |Mx Pdf Text Compare| ${filepath} | ${string} | prefix=${Prefix} | suffix=${Suffix} |

        4. To Validate Text In PDF For All Occurrence With Prefix And Suffix :
        |Mx Pdf Text Compare| ${filepath} | ${string} | prefix=${Prefix} | suffix=${Suffix} | all_occurrence=True |

        5. To Validate Text In PDF For All Occurrence With Prefix :
        |Mx Pdf Text Compare| ${filepath} | ${string} | prefix=${Prefix} | all_occurrence=True |

        6. To Validate Text In PDF For All Occurrence With Suffix :
        |Mx Pdf Text Compare| ${filepath} | ${string} | suffix=${Suffix} | all_occurrence=True |

        7. To Validate Text For a PDF Password Protected File With Suffix For All Occurrence :
        |Mx Pdf Text Compare| ${filepath} | ${string} | suffix=${Suffix} | all_occurrence=True | password=123456 |
    ...
    def mx_get_pdf_text(self, filepath, prefix=None, suffix=None, all_occurrence="False", password=None):
        ...
        | Mx Get Pdf Text | ${filepath} | prefix=${Prefix} | suffix=${Suffix}

        2. To Get PDF Text With Prefix And Suffix For All Occurrence :
        | Mx Get Pdf Text | ${filepath} | prefix=${Prefix} | suffix=${Suffix} | all_occurrence=True

        3. To Get PDF Text With Prefix For All Occurrence :
        | Mx Get Pdf Text | ${filepath} | prefix=${Prefix} | all_occurrence=True

        4. To Get PDF Text With Suffix For All Occurrence :
        | Mx Get Pdf Text | ${filepath} | suffix=${Suffix} | all_occurrence=True

        5. To Get PDF Text In The Form Of a List With Suffix For All Occurrence :
        | @{Stringfound} | Mx Get Pdf Text | ${filepath} | suffix=${Suffix} | all_occurrence=True

        6. To Get PDF Text In The Form Of a List For a Password Protected File With Suffix For All Occurrence :
        | @{Stringfound} | Mx Get Pdf Text | ${filepath} | suffix=${Suffix} | all_occurrence=True | password=123456 |
    ...
    def mx_pdf_text_compare_by_page_and_line_number(self, filepath, string=None, page_no=None, line_no=None, all_occurrence=False, password=None):
        ...
        """ Validates Text by page No and Line No in a PDF file.
                ...
                |Mx Pdf Text Compare| ${filepath} | ${string} | page_no=${Page_No} |

                2. To Validate Text In PDF With Page No For All Occurence :
                |Mx Pdf Text Compare| ${filepath} | ${string} | page_no=${Page_No} | all_occurrence=True |

                3. To Validate Text In PDF With Page No And Line No :
                |Mx Pdf Text Compare| ${filepath} | ${string} | page_no=${Page_No} | line_no=${Line_No} |

                4. To Validate Text For a PDF Password Protected File With Page No For All Occurence :
                |Mx Pdf Text Compare| ${filepath} | ${string} | page_no=${Page_No} | all_occurrence=True | | password=123456 |
...
# ins = PDFLibrary()
# ins.mx_get_pdf_text('D:/Git_Repo/utf_uat/SampleTests/LibraryTests/Common/PDFLibrary/SampleData/Account_Statement.pdf', prefix='calculate_iban', suffix='password')